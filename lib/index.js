(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('preact'), require('preact-render-to-string')) :
	typeof define === 'function' && define.amd ? define(['preact', 'preact-render-to-string'], factory) :
	(factory(global.Preact,global.render$1));
}(this, (function (preact,render$1) { 'use strict';

render$1 = 'default' in render$1 ? render$1['default'] : render$1;
...
function renderChildren(tab) {
  _tabComponentsChildren.push(render$1(tab[0]));
}
...
var Tabs = function (_Component) {
  ...
  Tabs.prototype.render = function render$1(_ref) {
    var children = _ref.children,
...
var Tab = function (_Component) {
  ...
  Tab.prototype.render = function render(_ref) {
    var value = _ref.value,
        label = _ref.label,
        props = objectWithoutProperties(_ref, ['value', 'label']);
