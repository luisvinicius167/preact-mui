  ...
  *	Benchmarks: https://esbench.com/bench/57ee8f8e330ab09900a1a1a0
  ...
  function innerDiffNode(dom, vchildren, context, mountAll) {
    ...
    if (vlen) {
      for (var _i2 = 0; _i2 < vlen; _i2++) {
        ...
        var _key2 = vchild.key;
        if (_key2 != null) {
          if (keyedLen && _key2 in keyed) {
            child = keyed[_key2];
            keyed[_key2] = undefined;
            keyedLen--;
          }
        }
        ...
        if (child && child !== dom) {
          ...
          } else if (child !== originalChildren[_i2]) {
            if (child === originalChildren[_i2 + 1]) {
              removeNode(originalChildren[_i2]);
            }
            dom.insertBefore(child, originalChildren[_i2] || null);
          }
        }
      }
    }
    ...
    if (keyedLen) {
      for (var _i3 in keyed) {
        if (keyed[_i3]) recollectNodeTree(keyed[_i3]);
      }
    }
  ...
  var Appbar = function (_Component) {
    ...
    Appbar.prototype.render = function render(_ref) {
      ...
      return h('div', _extends({ 'class': 'mui-appbar' }, props), children);
    };
  ...
  var Divider = function (_Component) {
    ...
    Divider.prototype.render = function render() {
      return h('div', { 'class': 'mui-divider' });
    };
  ...
  var Dropdown = function (_Component) {
    ...
    Dropdown.prototype.render = function render(_ref) {
      ...
      return h('div', { 'class': 'mui-dropdown' }, h(Button, { color: color, 'data-mui-toggle': 'dropdown' }, label, h('span', { 'class': 'mui-caret' })), h('ul', { 'class': 'mui-dropdown__menu ' + (alignMenu ? 'mui-dropdown__menu--' + alignMenu : false) }, children));
    };
  ...
  var DropdownItem = function (_Component) {
    ...
    DropdownItem.prototype.render = function render(_ref) {
      ...
      return h('li', null, h('a', { href: link ? link : false }, children));
    };
  ...
  var Form = function (_Component) {
    ...
    Form.prototype.render = function render(_ref) {
      ...
      return h('form', _extends({
        'class': inline ? 'mui-form--inline' : null
      }, props), legend ? h('legend', null, legend) : null, children);
    };
  ...
  var Input = function (_Component) {
    ...
    Input.prototype.render = function render(_ref) {
      ...
      }, props)), label ? h('label', null, label) : null);
    };
  ...
  var Checkbox = function (_Component) {
    ...
    Checkbox.prototype.render = function render(_ref) {
      ...
      return h('div', { 'class': 'mui-checkbox' }, h('label', null, h('input', _extends({}, props, {
        type: 'checkbox',
        name: name,
  ...
  var Radio = function (_Component) {
    ...
    Radio.prototype.render = function render(_ref) {
      ...
      return h('div', { 'class': 'mui-radio' }, h('label', null, h('input', _extends({}, props, {
        type: 'radio',
        name: name,
        checked: defaultChecked,
        disabled: disabled ? 'disabled' : null
  ...
  var Select = function (_Component) {
    ...
    Select.prototype.render = function render(_ref) {
      ...
      return h('div', { 'class': 'mui-select', style: style }, h('select', _extends({}, props, { disabled: disabled, value: defaultValue }), label ? h('label', null, label) : null, children));
    };
  ...
  var Option = function (_Component) {
    ...
    Option.prototype.render = function render(_ref) {
      ...
      return h('option', _extends({}, props, { value: value }), label);
    };
  ...
  var Row = function (_Component) {
    ...
    Row.prototype.render = function render(_ref) {
      ...
      return h('div', _extends({ 'class': 'mui-row' }, props), children);
    };
  ...
  var Col = function (_Component) {
    ...
    Col.prototype.render = function render(_ref) {
      ...
      return h('div', _extends({ 'class': className }, props), children);
    };
  ...
  var Panel = function (_Component) {
    ...
    Panel.prototype.render = function render(_ref) {
      ...
      return h('div', _extends({ 'class': 'mui-panel' }, props), children);
    };
  ...
  var Tabs = function (_Component) {
    ...
    Tabs.prototype.render = function render(_ref) {
      ...
      return h('ul', _extends({ 'class': className }, props), children);
    };
  ...
  var Tab = function (_Component) {
    ...
    Tab.prototype.render = function render(_ref) {
      ...
      return h('li', props, h('a', { 'data-mui-toggle': 'tab', 'data-mui-controls': value }, ' ', label, ' '));
    };
  ...
  var Modal = function (_Component) {
    ...
    Modal.prototype.render = function render(_ref, _ref2) {
      ...
      return h('div', { style: ModalPositions[this.props.position || 'center'], onClick: function onClick() {
          mui.overlay('off');
        } }, isActive ? h('div', props, children) : null);
    };
